...
exports.Transaction = ({ transaction, urlParams, location, waterfall }) => {
    if (lodash_1.isEmpty(transaction)) {
        return (react_1.default.createElement(EmptyMessage_1.default, { heading: "No transaction sample available.", subheading: "Try another time range, reset the search filter or select another bucket from the distribution histogram." }));
    }
