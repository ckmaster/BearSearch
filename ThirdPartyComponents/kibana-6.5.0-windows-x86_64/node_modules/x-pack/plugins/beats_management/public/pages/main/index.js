...
class MainPagesComponent extends react_1.default.PureComponent {
    ...
    render() {
        ...
        if (this.props.location.pathname === '/overview/initial/help') {
            return (react_1.default.createElement(no_data_1.NoDataLayout, { title: "Beats central management", actionSection: react_1.default.createElement(connected_link_1.ConnectedLink, { path: "/overview/initial/beats" },
